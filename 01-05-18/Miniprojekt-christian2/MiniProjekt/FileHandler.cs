...
namespace MiniProjekt
{
    class FileHandler
    {
        ...
        public static void ReadFile()
        {
            ...
            #region 
            var loadContent = new FileHandler(@"C:\Users\ferdi\Desktop\tennis_data\tennis_data\MalePlayer.txt");

            var malePlayers = new FileHandler(@"C:\Users\ferdi\Desktop\tennis_data\tennis_data\MalePlayer.txt");
            //malePlayers.LoadMalePlayer();
            //Console.WriteLine(malePlayers);

            var femalePlayers = new FileHandler(@"C:\Users\ferdi\Desktop\tennis_data\tennis_data\FemalePlayer.txt");
            //femalePlayers.LoadFemalePlayer();
            //Console.WriteLine(femalePlayers);

            var maleReferee = new FileHandler(@"C:\Users\ferdi\Desktop\tennis_data\tennis_data\MaleRefs.txt");
            //maleReferee.LoadMaleReferee();
            //Console.WriteLine(maleReferee);

            var femaleReferee = new FileHandler(@"C:\Users\ferdi\Desktop\tennis_data\tennis_data\FermaleRefs.txt");
