...
namespace MiniProjekt
{
    ...
    class TennisMatch
    {
        ...
        public TennisMatch()
        {
            ...
            //Checks the new objects of player is being called
            ...
            //Test player 01 is either male or female
            #region
            /*
            ...
            */
            ...
            if (player01.Gender == true && player02.Gender == true && Referee01.PlayerOrReferee == true)
            {
                ...
                if (player03.Gender == false && player04.Gender == false && Referee01.PlayerOrReferee == true)
                {
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.WriteLine("A singele female game has been set for player 01: {0} and player 2: {1}" + Environment.NewLine + Environment.NewLine + "The game will be controlled by the referee: {2} " + Environment.NewLine, player03.FirstName, player04.FirstName, Referee01.FirstName);
                    Console.ResetColor();
            ...
            //Der kan laves en catch hvis en mandelige og kvindlige spiller kommer imod hinanden
            else
            {
            ...
            public static void MaleMatch()
            {
                ...
                for (var i = 0; i < 5; i++)
                {
                    while (true)
                    {
                        //Points is given
                        #region
                        var dice = RandomGenerator.Next(0, 2);
                        if (dice == 0)
                        {
                            ++player01Point;
