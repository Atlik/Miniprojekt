...
namespace MiniProjekt
{
    ...
    class TennisMatch
    {
        ...
        public TennisMatch()
        {
            ...
            #region
            var player01 = new TennisPlayer("Christian", "Gundersen", "Holmgaard", new DateTime(1996, 05, 09), "Denmark", true, false);
            var player02 = new TennisPlayer("Ferdinand", "", "Brødløs", new DateTime(1995, 07, 19), "Denmark", true, false);
            var player03 = new TennisPlayer("Mia", "Bødker", "Nissen", new DateTime(1991, 11, 11), "Denmark", false, false);

            var Referee01 = new TennisPlayer("Kristian", "", "Torp", new DateTime(1983, 11, 11), "Denmark", true, true, new DateTime(2006, 08, 20), new DateTime(2018,04, 27));
            ...
            if (player01.Gender == true)
            {
                ...
                Console.WriteLine("test test, vi har med et hankøn gøre! Simulerer 5 set..." + Environment.NewLine);
                
            }
            else
            {
                Console.WriteLine("pas på! der er et hunkøn tilstede! Simulerer 3 set..." + Environment.NewLine);
            }
            Console.ResetColor();
